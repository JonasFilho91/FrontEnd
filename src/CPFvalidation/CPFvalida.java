...
public class CPFvalida {
    public String ValidarCPF(String cpf) {
        ...
        if (confere.equals(cpf)) {
            retornoverifica = "Cpf válido!";
            //JOptionPane.showMessageDialog(null, "Cpf válido!");
        }
        else if (cpf.length() == 13) {
            retornoverifica = "Detalhamento:Falta dígito do CPF!";
            //JOptionPane.showMessageDialog(null, "Detalhamento:Falta dígito do CPF!");
        }
        else {
            //JOptionPane.showMessageDialog(null, "Resultado:Erro!!Cpf inválido!");
            retornoverifica = "Resultado:Erro!!Cpf inválido!";
        }
